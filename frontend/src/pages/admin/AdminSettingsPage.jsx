...
const tabs = [
  ...
  { id: "hotel-info", label: "Khách sạn", icon: Hotel },
  {
    id: "team-management",
    label: "Nhóm quyền",
    icon: Users,
...
const AdminSettingsPage = () => {
  ...
  return (
    <div className="mx-auto max-w-[1680px] space-y-8 pb-20">
      <div className="flex flex-col gap-5 rounded-[2rem] border border-slate-200 bg-white px-6 py-7 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tight text-slate-950">Cài đặt</h1>
        ...
        <div className="flex flex-wrap gap-2 rounded-[1.6rem] border border-slate-200 bg-slate-50 p-2">
