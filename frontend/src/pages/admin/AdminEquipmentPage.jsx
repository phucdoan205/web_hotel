...
import {
    Box, Typography, Button, TextField, Grid, Paper, Table, TableBody, TableCell,
    TableContainer, TableHead, TableRow, IconButton, Dialog, DialogTitle,
    DialogContent, DialogActions, FormControl, InputLabel, Select, MenuItem,
    Chip, Switch, Pagination, Stack, InputAdornment
} from '@mui/material';
            ...
            <Paper sx={{ p: 2, mb: 3 }}>
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={12} sm={2} md={2}>
                        <Button variant="contained" fullWidth startIcon={<AddIcon />} onClick={() => handleOpenForm()}>
                            Thêm mới
                        </Button>
                    </Grid>
                </Grid>
            ...
            <Dialog open={openForm} onClose={handleCloseForm} maxWidth="md" fullWidth>
                ...
                <DialogContent sx={{ mt: 2 }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth label="Đơn vị (ví dụ: Cái, Bộ, Chiếc)" value={formData.unit} onChange={e => setFormData({ ...formData, unit: e.target.value })} required />
                        </Grid>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth label="Hình ảnh (URL)" value={formData.imageUrl} onChange={e => setFormData({ ...formData, imageUrl: e.target.value })} />
                        </Grid>
                    </Grid>
                </DialogContent>
                <DialogActions>
