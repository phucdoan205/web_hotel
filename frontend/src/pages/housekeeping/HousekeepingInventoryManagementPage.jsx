      ...
      <div className="w-full max-w-3xl overflow-hidden rounded-[2rem] border border-gray-100 bg-white shadow-2xl">
        ...
        <div className="space-y-5 px-8 py-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {item.resolvedAt ? (
              <span className="text-sm font-bold text-gray-500">Xử lý lúc {formatDateTime(item.resolvedAt)}</span>
            ) : null}
    ...
    <div className="animate-in space-y-6 fade-in duration-500">
      <header className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm font-bold text-gray-400">Theo dõi vật tư thiếu, hư hỏng và các khoản đền bù của Housekeeping.</p>
        </div>
