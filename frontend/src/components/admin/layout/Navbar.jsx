...
const Navbar = ({ onToggle, isSidebarOpen }) => {
  return (
    <header 
      className={`fixed top-0 right-0 z-30 flex h-16 lg:h-20 items-center justify-between border-b border-gray-100 bg-white px-4 lg:px-10 transition-all duration-300 ${
