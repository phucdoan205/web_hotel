...
const ProfileTab = () => {
  ...
  if (isLoading) {
    return (
      <div className="rounded-[2rem] border border-slate-200 bg-white p-8 text-sm font-semibold text-slate-400 shadow-sm">
        Đang tải hồ sơ...
      </div>
    );
  }
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 text-slate-900 shadow-sm">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="mt-5 text-2xl font-black text-slate-950">
                {displayProfile.fullName || "Quản trị viên"}
              </h3>
              <p className="mt-1 text-sm font-semibold text-slate-500">
                {displayProfile.roleName ?? "Admin"}
              </p>

              <button
                type="button"
                onClick={openEditModal}
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2.5 text-xs font-black uppercase tracking-[0.18em] text-white transition hover:bg-blue-700"
              >
            ...
            <div className="mb-6">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Xem thông tin tài khoản quản trị. Nhấn chỉnh sửa để cập nhật hồ sơ.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-6 p-6">
              <div className="flex flex-col items-center gap-4 rounded-[1.8rem] border border-slate-200 bg-slate-50 p-6 text-center">
                <div className="relative">
                  ...
                  />
                  <label className="absolute bottom-0 right-0 flex size-9 cursor-pointer items-center justify-center rounded-full border-2 border-white bg-blue-600 text-white transition hover:bg-blue-700">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="rounded-2xl bg-blue-600 px-6 py-3 text-xs font-black uppercase tracking-[0.18em] text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
