const PERMISSION_LABELS = {
  ...
  VIEW_MEMBERSHIPS: "Xem thành viên",
  EDIT_MEMBERSHIPS: "Sửa thành viên",
  CREATE_MEMBERSHIPS: "Tạo thành viên",
  DELETE_MEMBERSHIPS: "Xóa thành viên",
  VIEW_SERVICECATEGORIES: "Xem nhóm dịch vụ",
  CREATE_SERVICECATEGORIES: "Tạo nhóm dịch vụ",
  EDIT_SERVICECATEGORIES: "Sửa nhóm dịch vụ",
  DELETE_SERVICECATEGORIES: "Xóa nhóm dịch vụ",
  VIEW_ARTICLECATEGORIES: "Xem danh mục bài viết",
  EDIT_ARTICLECATEGORIES: "Sửa danh mục bài viết",
  CREATE_ARTICLECATEGORIES: "Tạo danh mục bài viết",
  DELETE_ARTICLECATEGORIES: "Xóa danh mục bài viết",
...
const PERMISSION_DESCRIPTIONS = {
  ...
  VIEW_MEMBERSHIPS: "Cho phép xem danh sách và thông tin thành viên.",
  CREATE_MEMBERSHIPS: "Cho phép tạo mới hạng thành viên.",
  EDIT_MEMBERSHIPS: "Cho phép cập nhật thông tin hạng thành viên.",
  DELETE_MEMBERSHIPS: "Cho phép xóa hạng thành viên.",
  VIEW_SERVICECATEGORIES: "Cho phép xem nhóm dịch vụ.",
  CREATE_SERVICECATEGORIES: "Cho phép tạo mới nhóm dịch vụ.",
  EDIT_SERVICECATEGORIES: "Cho phép sửa đổi nhóm dịch vụ.",
  DELETE_SERVICECATEGORIES: "Cho phép xóa nhóm dịch vụ.",
  VIEW_ARTICLECATEGORIES: "Cho phép xem danh mục bài viết.",
  CREATE_ARTICLECATEGORIES: "Cho phép tạo mới danh mục bài viết.",
  EDIT_ARTICLECATEGORIES: "Cho phép sửa đổi danh mục bài viết.",
  DELETE_ARTICLECATEGORIES: "Cho phép xóa danh mục bài viết.",
  VIEW_REVIEWS: "Cho phép xem danh sách đánh giá từ khách hàng.",
...
const SIDEBAR_PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Nhóm dịch vụ",
        permissionNames: ["VIEW_SERVICECATEGORIES", "CREATE_SERVICECATEGORIES", "EDIT_SERVICECATEGORIES", "DELETE_SERVICECATEGORIES"],
      },
    ],
  },
  {
    ...
    sections: [
      {
        id: "memberships-management",
        title: "Thành viên",
        permissionNames: ["VIEW_MEMBERSHIPS", "CREATE_MEMBERSHIPS", "EDIT_MEMBERSHIPS", "DELETE_MEMBERSHIPS"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "article-categories-management",
        title: "Danh mục bài viết",
        permissionNames: ["VIEW_ARTICLECATEGORIES", "CREATE_ARTICLECATEGORIES", "EDIT_ARTICLECATEGORIES", "DELETE_ARTICLECATEGORIES"],
      },
    ],
  },
  {
